/*********************************************************
 *  MSP1.jsx - Masked Script with Parameters
 *  Based on masked2.jsx but accepts 3 file path parameters
 *  Outputs synthesized files to Target folder
 *********************************************************/
#target illustrator
...
(function () {
    ...
    try {
        ...
        log("===== MSP1.jsx COMPLETED SUCCESSFULLY =====");
        
    } catch(err) {
        $.global.MSP_success = false;
        $.global.MSP_errorMessage = err.message;
        log("===== MSP1.jsx FAILED: " + err.message + " =====");
    } finally {
        logFile.close();
    }
})();