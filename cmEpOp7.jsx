...
function updateSynthesizedNames2() {
    // Implementation for BluePrint #2 if needed
}

function updateSynthesizedNames3() {
    // Implementation for BluePrint #3 if needed
}
...
blueprint2Button.onClick = function() {
    ...
    if (selectedFile != null) {
        ...
        try {
            ...
            // Update status text to confirm placement
            statusText.text = "[OK] 2d BluePrint #2 placed at (1,3). Checking for Targets...";
            
            // NEW: Try to place synthesized Target files at (2,3) and (3,3)
...
blueprint3Button.onClick = function() {
    ...
    if (selectedFile != null) {
        ...
        try {
            ...
            // Update status text to confirm placement
            statusText.text = "[OK] 2d BluePrint #3 placed at (1,4). Checking for Targets...";
            
            // NEW: Try to place synthesized Target files at (2,4) and (3,4)
