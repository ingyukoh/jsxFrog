...
blueprintButton.onClick = function() {
    ...
    if (selectedFile != null) {
        ...
        try {
            ...
            // NEW: Execute MSP1_compound.jsx if PatCol and PatBlk are selected
            if (selectedPatCol && selectedPatBlk) {
                logToFile("MSP_START", "Starting MSP1_compound.jsx execution");
                try {
                    ...
                    // Execute MSP1_compound.jsx synchronously
                    var scriptFile = new File($.fileName);
                    var scriptFolder = scriptFile.parent;
                    var mspScript = new File(scriptFolder + "/MSP1_compound.jsx");
                    ...
                    if (mspScript.exists) {
                        ...
                        if ($.global.MSP_success) {
                            logToFile("MSP_SUCCESS", "MSP1_compound.jsx completed successfully");
                            logToFile("MSP_OUTPUT", "Created " + $.global.MSP_outputPaths.length + " files");
                            statusText.text = "[OK] Masked files generated. Placing images...";
                        } else {
                            logToFile("MSP_FAILED", "MSP1_compound.jsx failed: " + $.global.MSP_errorMessage);
                            statusText.text = "[ERROR] Masking failed: " + $.global.MSP_errorMessage;
                        }
                    } else {
                        logToFile("MSP_ERROR", "MSP1_compound.jsx not found in: " + scriptFolder.fsName);
                        statusText.text = "[ERROR] MSP1_compound.jsx not found";
                    }
                    
                } catch (mspError) {
                    logToFile("MSP_ERROR", "Error executing MSP1_compound.jsx: " + mspError.toString());
...
blueprint2Button.onClick = function() {
    ...
    if (selectedFile != null) {
        ...
        try {
            ...
            // NEW: Execute MSP1_compound.jsx if PatCol and PatBlk are selected
            if (selectedPatCol && selectedPatBlk) {
                logToFile("MSP2_START", "Starting MSP1_compound.jsx execution for BluePrint #2");
                try {
                    // Set global parameters for MSP1
                    $.global.MSP_patColPath = selectedPatCol.fsName;
                    $.global.MSP_patBlkPath = selectedPatBlk.fsName;
                    ...
                    if (mspScript.exists) {
                        ...
                        // Check results
                        if ($.global.MSP_success) {
                            logToFile("MSP2_SUCCESS", "MSP1_compound.jsx completed successfully for BluePrint #2");
                            logToFile("MSP2_OUTPUT", "Created " + $.global.MSP_outputPaths.length + " files");
                            statusText.text = "[OK] Masked files generated. Placing images...";
                        } else {
                            logToFile("MSP2_FAILED", "MSP1_compound.jsx failed: " + $.global.MSP_errorMessage);
                            statusText.text = "[ERROR] Masking failed: " + $.global.MSP_errorMessage;
                        }
                    } else {
                        logToFile("MSP2_ERROR", "MSP1_compound.jsx not found in: " + scriptFolder.fsName);
                        statusText.text = "[ERROR] MSP1_compound.jsx not found";
                    }
                    
                } catch (mspError) {
                    logToFile("MSP2_ERROR", "Error executing MSP1_compound.jsx: " + mspError.toString());
                    statusText.text = "[ERROR] " + mspError.toString();
                }
            } else {
...
blueprint3Button.onClick = function() {
    ...
    if (selectedFile != null) {
        ...
        try {
            ...
            // NEW: Execute MSP1_compound.jsx if PatCol and PatBlk are selected
            if (selectedPatCol && selectedPatBlk) {
                logToFile("MSP3_START", "Starting MSP1_compound.jsx execution for BluePrint #3");
                try {
                    // Set global parameters for MSP1
                    $.global.MSP_patColPath = selectedPatCol.fsName;
                    $.global.MSP_patBlkPath = selectedPatBlk.fsName;
                    ...
                    if (mspScript.exists) {
                        ...
                        // Check results
                        if ($.global.MSP_success) {
                            logToFile("MSP3_SUCCESS", "MSP1_compound.jsx completed successfully for BluePrint #3");
                            logToFile("MSP3_OUTPUT", "Created " + $.global.MSP_outputPaths.length + " files");
                            statusText.text = "[OK] Masked files generated. Placing images...";
                        } else {
                            logToFile("MSP3_FAILED", "MSP1_compound.jsx failed: " + $.global.MSP_errorMessage);
                            statusText.text = "[ERROR] Masking failed: " + $.global.MSP_errorMessage;
                        }
                    } else {
                        logToFile("MSP3_ERROR", "MSP1_compound.jsx not found in: " + scriptFolder.fsName);
                        statusText.text = "[ERROR] MSP1_compound.jsx not found";
                    }
                    
                } catch (mspError) {
                    logToFile("MSP3_ERROR", "Error executing MSP1_compound.jsx: " + mspError.toString());
                    statusText.text = "[ERROR] " + mspError.toString();
                }
            } else {
